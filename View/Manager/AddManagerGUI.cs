    ...
    public partial class AddManagerGUI : Form
    {
        ...
        private void Savebutton_Click(object sender, EventArgs e)
        {
            ...
            var manager = new Models.Manager(
                ...
                managerType: (ManagerType)(ManagerTypecomboBox.SelectedIndex + 1),
            ...
            MessageBox.Show("Manager saved successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ClearFields();
        }
        ...
        private bool ValidateInputs()
        {
            ...
            {
                MessageBox.Show("Manager ID is required.", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning);
