...
namespace SuperMart_Pro.View.Cashier
{
    public partial class AddCashierGUI : Form
    {
        ...
        private void Savebutton_Click(object sender, EventArgs e)
        {
            ...
            var cashier = new Models.Cashier(
                cashierID: CashierIDtextBox.Text.Trim(),
                cashierType: (CashierType)(CashierTypecomboBox.SelectedIndex + 1),
            ...
            MessageBox.Show("Cashier saved successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ClearFields();
        }
        ...
        private bool ValidateInputs()
        {
            ...
            {
                MessageBox.Show("Cashier ID is required.", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            // TODO: open branch search dialog and populate BranchIDtextBox / BranchNametextBox
        }
    }
}
